...
class CaseReader:
    '''Instance Reader'''
    def __init__(self, current_instance_path='', config_layout_path=''):
        self.current_instance = read_json(current_instance_path)
        self.config_layout = read_json(config_layout_path)
        self.num_jobs = len(self.current_instance['plate_list'])
        self.num_mas = len(self.config_layout['Nodes'])